...
public:
    ...
    virtual void update(const Vector2& playerPosition, float deltaTime);
    ...
    bool isAlive = true;
protected:
    Level *m_level; // Stored as a reference or pointer as needed.

    // Change m_speed to protected:
    float m_speed = 75.0f;


    // For animations:// e.g., 0: down, 1: up, etc.
    float stepCount = 0.0f;

    // You may have other members here...
